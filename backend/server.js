...
// POST / students -- recieves new students and inserts into mySQL
...
// POST /users -- creates new user account
app.post("/users", (req, res) => {
    ...
    if (password.length < 8){
        return res.status(400).json({ error: "Password must be at least eight characters long." });
    }
    const specialChar= /[!@#$%]/
    ...
    //  auto link students to table by matching first and last names
...
// GET /students/:id/attendance -- returns student attendance
